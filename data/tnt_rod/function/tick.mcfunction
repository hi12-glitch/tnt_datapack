...
execute as @a[scores={tntRodDelta=1..},nbt={SelectedItem:{id:"minecraft:fishing_rod",tag:{CustomModelData:7001}}}] run function tnt_rod:strike/tnt_drill_cast

# Nuke Rod trigger
execute as @a[scores={tntRodDelta=1..},nbt={SelectedItem:{id:"minecraft:fishing_rod",tag:{CustomModelData:7002}}}] run function tnt_rod:strike/nuke_cast
